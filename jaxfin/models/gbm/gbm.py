...
class MultiGeometricBrownianMotion:
    ...
    def simulate_paths(self, seed: int, maturity, n: int) -> jax.Array:
        """
        Simulate a sample of paths from the GBM
